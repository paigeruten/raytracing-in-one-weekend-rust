...
fn main() {
    ...
    let material_left2  = Rc::new(Dielectric::new(1.5)); // can't figure out how to reuse material_left :(
    ...
    world.add(Rc::new(Sphere::new(Point3::new(-1.0,    0.0, -1.0), -0.45, material_left2)));
